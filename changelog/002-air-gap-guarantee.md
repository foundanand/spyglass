...
- **README intro** now leads with the air-gap positioning: the "no phone-home" bullet calls out _zero outbound calls / runs fully disconnected_ and links to the enforcing test.
